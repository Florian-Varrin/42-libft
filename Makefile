...
#    Updated: 2021/12/02 12:51:48 by fvarrin          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC		= $(addprefix ${SRC_DIR}, ft_isalpha.c ft_isdigit.c ft_isspace.c ft_isalnum.c ft_isascii.c ft_isprint.c ft_strlen.c ft_memset.c ft_bzero.c ft_memcpy.c ft_memmove.c \
			...
			ft_itoa.c ft_strmapi.c ft_striteri.c ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c ft_putnbr_fd.c ft_printf.c ft_printf_put.c ft_printf_utils.c)
OBJ		= $(SRC:.c=.o);
CC 		= gcc
AR 		= ar rc
NAME 		= libft.a
